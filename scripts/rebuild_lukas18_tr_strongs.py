#!/usr/bin/env python3
"""Publiceer de TR-woordnummers voor Lukas 18."""
...
def build(utr:Path,osis:Path,write:bool=False)->dict[str,int]:
 s=load_tr_chapter(utr,osis,chapter=18,osis_book="Luke"); p=ROOT/"data"/"lukas"/"18.json"; d=json.loads(p.read_text(encoding="utf-8")); q={"book":"lukas","chapter":18,"reviewed_through":43,"verses":{}}
 for v in d["verses"]:
 ...
 if write:
  p.write_text(json.dumps(d,ensure_ascii=False,indent=2)+"\n",encoding="utf-8");(ROOT/"data"/"woordnummers-review"/"lukas-18.json").write_text(json.dumps(q,ensure_ascii=False,indent=2)+"\n",encoding="utf-8");ip=ROOT/"data"/"woordnummers-inline"/"lukas.json";i=json.loads(ip.read_text(encoding="utf-8"));i["18"]=q;ip.write_text(json.dumps(i,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
