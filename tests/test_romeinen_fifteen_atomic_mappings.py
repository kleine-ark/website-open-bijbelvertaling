...
GROUND_SHA = "1F6BB4E0B1EC48245A86EE8569C8A37AF5729C4C30BDC082EA18F1065FCEB86B"
...
def test_romeinen_15_rejects_whole_verse_mappings_and_covers_every_ground_token():
    chapter = _load(ROOT / "data" / "romeinen" / "15.json")
    review_path = ROOT / "data" / "woordnummers-review" / "romeinen-15.json"
    ...
    assert list(records) == list(range(1, 34))
    assert book["reviewbeperking"]["verzen"] == list(range(1, 34))
