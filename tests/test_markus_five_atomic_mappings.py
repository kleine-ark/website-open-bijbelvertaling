...
EXPECTED_GROUND_SHA = "A78A76B9F97E67508A0217E8616C73230262998DCEDA533C96E1C6993377F831"
...
def test_markus_five_review_is_atomic_complete_pinned_and_reachable():
    chapter = _load(ROOT / "data" / "markus" / "5.json")
    review_path = ROOT / "data" / "woordnummers-review" / "markus-5.json"
