...
EXPECTED_GROUND_SHA = "1EC974C0703CFFD192144B69F885B2DE4E826A049788838832513363481EF7F9"
...
def test_markus_seven_review_is_atomic_complete_pinned_and_reachable():
    chapter = _load(ROOT / "data" / "markus" / "7.json")
    review_path = ROOT / "data" / "woordnummers-review" / "markus-7.json"
    ...
    assert mapping_count == 627
    assert link_count == 631
