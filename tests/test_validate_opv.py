...
class OpvCalibrationCorpusTests(unittest.TestCase):
    ...
    def test_productie_cli_meldt_de_volledige_gepubliceerde_pilot(self) -> None:
        ...
        self.assertEqual("OPV geldig: 50 hoofdstukken, 1601 verzen.\n", result.stdout)
...
class OpvGenesisPilotTests(unittest.TestCase):
    ...
    def test_genesis_has_exact_source_verse_lists_and_1387_verses(self) -> None:
        total = 0
    ...
    def test_publication_registers_both_complete_pilot_books(self) -> None:
        ...
        expected = {"genesis": list(range(1, 46)), "johannes": [1, 2, 3, 4, 5]}
...
class OpvJohannesPilotTests(unittest.TestCase):
    ...
    def test_johannes_has_source_verse_lists_214_verses_and_corpus_1601(self) -> None:
        total = 0
        ...
        self.assertEqual(1601, total + genesis_total)
