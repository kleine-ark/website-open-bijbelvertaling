...
EXPECTED_GROUND_SHA = "4909F26AA6FDA54BAA603590349E3835B58939BA5C7BA1C89412525A0210B7BE"
...
def test_markus_thirteen_review_is_atomic_complete_pinned_and_reachable():
    chapter = _load(ROOT / "data" / "markus" / "13.json")
    review_path = ROOT / "data" / "woordnummers-review" / "markus-13.json"
    ...
    assert [record["verse"] for record in book["verses"]] == list(range(1, 38))
    ...
    assert mapping_count == 621
    assert link_count == 635


def test_markus_thirteen_no_long_whole_verse_mapping_remains():
    review = _load(ROOT / "data" / "woordnummers-review" / "markus-13.json")
