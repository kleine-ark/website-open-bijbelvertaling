...
EXPECTED_GROUND_SHA = "6348C738DBBD592180D0A48B8667AC2DFCE24EE7BF5CC7107C207CB9041AB8F9"
...
def test_markus_six_review_is_atomic_complete_pinned_and_reachable():
    chapter = _load(ROOT / "data" / "markus" / "6.json")
    review_path = ROOT / "data" / "woordnummers-review" / "markus-6.json"
    ...
    assert mapping_count == 915
    assert link_count == 1017
