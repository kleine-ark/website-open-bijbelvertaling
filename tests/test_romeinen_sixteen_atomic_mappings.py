...
GROUND_SHA = "9A73D04E35DA692C055E0B41954873346A5DE6C3CEDA93CF8E517405F570F503"
...
def test_romeinen_16_rejects_whole_verse_mappings_and_covers_every_ground_token():
    chapter = _load(ROOT / "data" / "romeinen" / "16.json")
    review_path = ROOT / "data" / "woordnummers-review" / "romeinen-16.json"
