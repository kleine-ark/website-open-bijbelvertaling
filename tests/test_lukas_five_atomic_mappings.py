...
def test_lukas_five_review_is_atomic_complete_pinned_and_reachable():
    chapter = _load(ROOT / "data" / "lukas" / "5.json")
    review_path = ROOT / "data" / "woordnummers-review" / "lukas-5.json"
    ...
    assert mapping_count == 650
    assert link_count == 762
