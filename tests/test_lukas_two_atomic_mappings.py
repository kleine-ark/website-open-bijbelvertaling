...
def test_lukas_two_review_is_atomic_complete_pinned_and_reachable():
    chapter = _load(ROOT / "data" / "lukas" / "2.json")
    review_path = ROOT / "data" / "woordnummers-review" / "lukas-2.json"
    ...
    assert 800 <= mapping_count <= 864
    assert link_count == 864
