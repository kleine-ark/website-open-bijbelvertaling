...
def test_lukas_four_review_is_atomic_complete_pinned_and_reachable():
    chapter = _load(ROOT / "data" / "lukas" / "4.json")
    review_path = ROOT / "data" / "woordnummers-review" / "lukas-4.json"
    ...
    assert 720 <= mapping_count <= 799
    assert link_count == 799
