...
def test_lukas_three_review_is_atomic_complete_pinned_and_reachable():
    chapter = _load(ROOT / "data" / "lukas" / "3.json")
    review_path = ROOT / "data" / "woordnummers-review" / "lukas-3.json"
    ...
    assert 550 <= mapping_count <= 594
    assert link_count == 594
