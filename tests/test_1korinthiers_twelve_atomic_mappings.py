...
GROUND_SHA = "288DEB52D23A75FFA1327A173868D176DD5071A89F5BD3891D32ACAE2E003B90"
...
def test_1korinthiers_12_review_is_atomic_complete_pinned_and_reachable():
    chapter = _load(ROOT / "data" / "1korinthiers" / "12.json")
    review_path = ROOT / "data" / "woordnummers-review" / "1korinthiers-12.json"
    ...
    assert link_count == 475


def test_1korinthiers_12_publishes_all_475_links_at_atomic_targets():
    chapter = _load(ROOT / "data" / "1korinthiers" / "12.json")
    inline = _load(ROOT / "data" / "woordnummers-inline" / "1korinthiers.json")
    inline_verses = inline["chapters"]["12"]
...
def test_1korinthiers_12_keeps_every_runtime_target_unambiguous():
    chapter = _load(ROOT / "data" / "1korinthiers" / "12.json")
    for verse in chapter["verses"]:
