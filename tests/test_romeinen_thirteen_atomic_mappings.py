...
GROUND_SHA = "169AD0A81E131B122A6C1E0AF2F4DC9E936FEA1C3817B34D98D58D35447CF879"
...
def test_romeinen_13_rejects_whole_verse_mappings_and_covers_every_ground_token():
    chapter = _load(ROOT / "data" / "romeinen" / "13.json")
    review_path = ROOT / "data" / "woordnummers-review" / "romeinen-13.json"
    ...
    assert list(records) == list(range(1, 15))
    assert book["reviewbeperking"]["verzen"] == list(range(1, 15))
