...
EXPECTED_GROUND_SHA = "502878916AECE702E696463A09EF5584B7B465A3F88B1050550A546CCE33F64C"
...
def test_markus_two_review_is_atomic_complete_pinned_and_reachable():
    chapter = _load(ROOT / "data" / "markus" / "2.json")
    review_path = ROOT / "data" / "woordnummers-review" / "markus-2.json"
    ...
    assert [record["verse"] for record in book["verses"]] == list(range(1, 29))
    ...
    assert mapping_count == 549
    assert link_count == 560
