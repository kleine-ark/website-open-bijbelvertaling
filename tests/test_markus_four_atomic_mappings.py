...
EXPECTED_GROUND_SHA = "D83BB50216B96A00B002DB9B5679AB01C8F7086CF0E33D578C7B1F5691180ECC"
...
def test_markus_four_review_is_atomic_complete_pinned_and_reachable():
    chapter = _load(ROOT / "data" / "markus" / "4.json")
    review_path = ROOT / "data" / "woordnummers-review" / "markus-4.json"
    ...
    assert [record["verse"] for record in book["verses"]] == list(range(1, 42))
    ...
    assert mapping_count == 686
    assert link_count == 697
