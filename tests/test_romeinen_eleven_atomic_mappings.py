...
GROUND_SHA = "6B6723CCC589AFC0C9EC7D9FAD6B776029C60C3FCD81787F1840751E17EE7E16"
...
def test_romeinen_11_rejects_whole_verse_mappings_and_covers_every_ground_token():
    chapter = _load(ROOT / "data" / "romeinen" / "11.json")
    review_path = ROOT / "data" / "woordnummers-review" / "romeinen-11.json"
    ...
    assert list(records) == list(range(1, 37))
    assert book["reviewbeperking"]["verzen"] == list(range(1, 37))
