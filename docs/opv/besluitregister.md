...
- Genesis 1: 1–2 het begin; 3–5 licht en donker; 6–8 hemelgewelf; 9–13 land en planten; 14–19 hemellichten; 20–23 waterdieren en vogels; 24–31 landdieren en mensen.
- Johannes 1: 1–5 Woord en Licht; 6–13 Johannes en het Licht; 14–18 menswording; 19–28 Johannes’ identiteit; 29–34 Lam en Geest; 35–43 eerste leerlingen; 44–52 Filippus en Nathanaël.

Johannes telt hier 52 verzen, omdat de repository de gebruikelijk als 1:38 genummerde passage in twee versregels bewaart. Repo-vers 38 eindigt na Jezus’ inleiding op Zijn vraag; repo-vers 39 bevat de vraag en het antwoord van de leerlingen. Dit is zichtbaar in SV1888, SV1637, OV én de Griekse woorden: vers 38 eindigt met `λεγει αυτοις`, vers 39 begint met `τι ζητειτε`. Vanaf repo-vers 39 loopt de nummering één hoger. Er is geen extra gebeurtenis en geen nieuwe inhoud toegevoegd. Vers 43 bevat Simon/Cefas, dus het leerlingenblok eindigt op 43; de nieuwe dag met Filippus begint bij vers 44. De laatste belofte blijft repo-vers 52.

## Genesis

### G1 — 1:2: leegte, waterdiepte en Geest
...
De drie Nederlandse bronnen bewaren tekenen, gezette/vastgestelde tijden, dagen en jaren. De Hebreeuwse reeks noemt `otot`, `mo‘adim`, dagen en jaren.

Besluit: de lichten “als tekenen” laten dienen en de “vastgestelde tijden, de dagen en de jaren” laten aangeven. Tekenen zijn niet teruggebracht tot alleen tijdsaanduiding. Geen beperking tot seizoenen, feestdagen of astrologische voortekenen. Begrip: `vaste-tijden`.

### G4 — 1:20–21: levende zielen en grote waterdieren
...
SV1888 en SV1637 verbinden de formulering zichtbaar met “een iegelijk mens, komende in de wereld”; OV bewaart dezelfde zinsbouw. De Griekse vorm `erchomenon` laat discussie over de verbinding toe.

Besluit: “Het verlicht ieder mens die in de wereld komt” volgt de Nederlandse basistekst. De alternatieve verbinding met het komende Licht is niet stilzwijgend ingevoerd. “Ieder” blijft behouden; er wordt niet beweerd dat iedereen daardoor gered is.

### J3 — 1:13: oorsprong van Gods kinderen

De bronnen onderscheiden bloed, wil van het vlees, wil van de man en God. De Griekse opsomming `haimaton / thelematos sarkos / thelematos andros / ek theou` is afzonderlijk gecontroleerd.

Besluit: “uit God geboren”, gevolgd door “niet door hun afkomst, niet door lichamelijk verlangen en niet door de wil van een man”. Alle drie ontkenningen blijven apart staan. De passage gaat over het ontstaan van Gods kindschap; er wordt geen algemene afwijzing van lichamelijkheid of voortplanting van gemaakt. Begrip: `geboren-uit-god`.

### J4 — 1:14: menswording en heerlijkheid
...
SV1888 en beide controlevertalingen lezen eniggeboren Zoon. Ook de plaatselijk opgeslagen Griekse tekst leest `monogenes huios`, niet de andere bekende lezing met God. `eis ton kolpon tou patros` bewaart de bijzondere nabijheid.

Besluit: de SV/plaatselijke grondtekstlezing “enige Zoon” blijft leidend. “Heel dicht bij de Vader” geeft de relatie in gewone taal weer zonder een lichamelijke zithouding te suggereren. “Heeft ons laten zien wie God is” parafraseert verklaard. De ontkenning dat iemand God ooit gezien heeft blijft onverkort. Een handschriftkeuze wordt niet zonder apart onderzoek omgezet in hoofdtekst.
...
### J8 — 1:29: het Lam en de zonde

De drie Nederlandse bronnen lezen Lam Gods, de zonde der wereld en wegnemen. Het Grieks gebruikt `amnos`, `hamartia` en `airon`.

Besluit: “Lam van God” blijft als essentieel beeld behouden, niet vervangen door een uitleg als offer of redder. “De zonde van de wereld” blijft collectief enkelvoud; de wereld wordt niet tot één volk of groep beperkt. “Wegneemt” volgt de primaire bron. De uitleglaag benoemt de koppeling zonder een uitgewerkte verzoeningsleer in te voegen.
...
### J10 — 1:38–43: versgrens, tijd en namen
...
Jezus uit Nazareth, zoon van Jozef, blijft een uitspraak van Filippus; dit is geen toegevoegde redactionele conclusie over Jezus’ geboorte. Nathanaëls vraag over Nazareth blijft een vraag. De vijgenboom, het eerdere zien en de belofte van grotere dingen blijven behouden. Het geloof in vers 51 wordt als constatering weergegeven, conform SV1888, niet als afkeurende vraag.

### J12 — 1:52: dubbele bevestiging en Mensenzoon
...
Vers 4 vertelt over het ontstaan van hemel en aarde en herhaalt aarde en hemel in de tweede zin. Vers 5 luidt nu: “Er waren nog geen struiken op het land. Veldplanten waren nog niet opgekomen.” De twee voorafgaande toestanden uit SV1888, “eer hij in de aarde was” en “eer het uitsproot”, worden rechtstreeks verteld. De plaatselijke grondtekst onderscheidt eveneens `terem yihyeh` (nog niet aanwezig zijn) en `terem yitsmach` (nog niet opkomen). De totale afwezigheid bewaart het bereik van beide bronvermeldingen “al”: er worden geen uitzonderingen binnen de genoemde vegetatiegroepen gemaakt. Geen regen en geen mens om de grond te bewerken blijven beide redenen. De damp uit vers 6 blijft damp, zonder omzetting in een bron, miststelsel of meteorologisch model.

Dit is een expliciete herziening van de eerdere zinsverbinding volgens kanttekeningen 8–9. Eerder werd het maken uit vers 4 nog tweemaal in vers 5 uitgeschreven en daarna de toestand vóór het maken benoemd. Dat leverde omgekeerde woordvolgorde en een tautologische terugblik op. Het maken blijft nu waar het in SV1888 uitdrukkelijk staat: vers 4. Vers 5 vertelt de nog-niet-toestand en de twee redenen, zonder een nieuw maakwerkwoord. De kanttekening legt dit uit als schepping zonder regen of menselijke arbeid; die uitleg wordt niet als extra handeling in vers 5 ingevoegd. Er wordt geen andere scheppingsdag, tweede schepping of landbouwtheorie vastgesteld. De gewijzigde zinsverbinding moet als redactionele keuze worden beoordeeld, niet worden voorgesteld als louter spellingmodernisering.
...
Het goddelijke meervoud in 3:22 blijft “een van ons”; geen uitleg van de groep. Hand uitsteken, nemen, eten en eeuwig leven blijven onderscheiden als mogelijkheid: “Nu zou hij ook zijn hand kunnen uitsteken” en “Hij zou daarvan kunnen nemen en eten”. “Dat moet worden voorkomen” ontvlecht de afwerende bronzin “dat hij ... niet”. Het is geen nieuw tot de mens gericht verbod: de aangesprokenenlijst blijft leeg en de hele gedachte blijft binnen Gods citaat. Vers 23 noemt expliciet “De mens” als degene die de grond moet bewerken, zodat Hij niet voor God wordt aangezien. Cherubim wordt “cherubs”, met uitleg; hun uiterlijk en aantal worden niet ingevuld. God plaatst de cherubs én het vlammende, bewegende zwaard. “Zo liet Hij de weg naar de boom van het leven bewaken” verbindt het doel met die gecombineerde plaatsing, niet uitsluitend met de cherubs. Er wordt niet beweerd dat een cherub het zwaard vasthoudt.
...
De gelijknamige Lamechs zijn verschillende personen: Kaïns afstammeling en zoon van Methusael in Genesis 4 tegenover Noachs vader en zoon van Methusalach in Genesis 5. Daarom krijgen de citaten in 4:23–24 spreker-id `lamech-kain`, en 5:29 `lamech-noach`; hun zichtbare naam blijft Lamech. De gebeurtenisgebonden semantic-id's gebruiken respectievelijk `spraak.lamechkain` en `spraak.lamechnoach`. Beide uitspraken in Genesis 4 houden dezelfde spreker-identiteit.
...
Oude lengtematen, inhoudsmaten en gewichten worden in de leestekst afgerond omgerekend. Een el is ongeveer 45 centimeter, een span ongeveer 22 centimeter, een handbreed ongeveer 7,5 centimeter en een talent ongeveer 34 kilo. Een hin wordt voor deze passages afgerond op ongeveer vier liter. Een heiligdomssikkel blijft als historische eenheid genoemd waar de onderlinge verhouding zelf betekenis draagt; de tekst geeft daarnaast ongeveer 11 gram per sikkel en 5,5 gram per halve sikkel. Bij samengestelde maten wordt een natuurlijke eenheid gekozen, bijvoorbeeld 2,5 el als ongeveer 1,1 meter. `Ongeveer`, `circa` of een andere duidelijke afrondingsmarkering voorkomt schijnprecisie. De broneenheid en de exacte SV1888-formulering blijven controleerbaar in de bronlaag.
...
### A4 — Heer en Heere in 4 Ezra

4 Ezra bestaat bijna helemaal uit gesprekken tussen Ezra en de engel Uriël, en de bron laat die engel voortdurend in de eerste persoon van God spreken: `om hunnentwil heb ik de wereld gemaakt` (7:11), `mijn Zoon` (7:28), `mijn oordeel` (5:42). De Statenvertaling schrijft de aanspreekvorm dan ook nu eens als `Here` en dan weer als `mijn God` (7:3). Deze uitgave volgt de grammaticale gesprekspartner: zolang Ezra met de engel praat staat er heer met kleine letter en u zonder eerbiedshoofdletter, en de citaatopmaak blijft die van de engel. Alleen waar Ezra zich met de gebedsformule `O heersende Heere` uitdrukkelijk tot God richt, staat er Heere en gelden de eerbiedshoofdletters voor de hele rede die daarmee begint. Waar de engel woorden van een derde doorgeeft — Jeremiël in 4:36, Mozes in 7:59, God in de aanklacht van de leeuw in 11:39 — staat dat als citaat binnen het citaat.

Drie plaatsen in de bron vragen om uitleg. Het boek opent met `Het tweede boek van de profeet Ezra`; die telling van de Statenvertaling blijft staan, ook al heet het boek in deze uitgave 4 Ezra. Hoofdstuk 7 heeft zeventig verzen, zoals in de Statenvertaling; het lange stuk dat andere handschriften tussen 7:35 en 7:36 hebben, ontbreekt daar en is niet aangevuld. En in 14:8 staat in de Statenvertaling `de tekenen die ik gedroomd heb`, wat in de eerste persoon van God geen zin geeft; de parafrase leest hier de tekenen die ik je gegeven heb. De bronfrase bewaart in alle drie de gevallen de regel zoals hij er staat.

### A5 — De leerrede in het Boek der Wijsheid

Het Boek der Wijsheid is één doorlopend betoog, en betoog krijgt geen citaatopmaak, net als in Spreuken en Prediker. Alleen wat er binnen dat betoog werkelijk gezegd wordt, staat in de opmaak: de overweging van de goddelozen in 2:1 tot 20 en hun spijt in 5:3 tot 14. Vanaf hoofdstuk 11 spreekt het boek God rechtstreeks aan met U; dat is de vorm van het betoog zelf en geen aangehaald gebed, dus ook daar staat geen citaat omheen. Het gebed in hoofdstuk 9 is de uitzondering, want 8:21 kondigt het aan met `ging ik naar de Heere toe, bad ik tot Hem en sprak ik uit heel mijn hart`. De spreker heet in de sprekerslijst de koning die aan het woord is en niet Salomo, omdat het boek zelf geen naam noemt.

In 4:17 staat in de Statenvertaling `wij zullen zien het einde van de wijze, en niet bedenken wat zij over hem beraadslaagd hebben`, waarin het onderwerp halverwege omslaat. De parafrase leest hier zij, omdat vers 18 diezelfde groep voortzet met `Zij zullen het zien`. De bronfrase bewaart de regel zoals hij er staat.

### A6 — Griekse goden in de Makkabeeënboeken
...
### A12 — 2 Meqabyan: verhaal, rede en betoog

2 Meqabyan begint als verhaal en eindigt als betoog. In het verhaal krijgt de spraak gewoon opmaak: de profeet Reday tegen Meqabis in 2:1 tot 8, met de woorden van God als citaat binnen het citaat vanaf `Maar ik zeg je` in 2:3 tot en met 2:7; het woord van God aan de profeet in 3:3 tot 10; de belijdenis van Meqabis in 3:11 en 12; het antwoord van de profeet in 3:13 en 14; het bevel van koning Tsirutsaydan en het weigeren van de zonen van Meqabis in 6:10 en 11; de rede van de zonen in 6:16 tot 7:6; de grootspraak van de koning in 8:6 en 12:12; en het gesprek van Balak en Bileam in 10:4 tot 15, met het woord aan Jakob als citaat binnen het citaat in 10:14.

Vanaf hoofdstuk 13 wordt het boek een betoog over de opstanding van de doden, en daar geldt dezelfde regel als in Jezus Sirach: de lerende stem krijgt geen opmaak, maar wat zij aanhaalt wel. Zo staan de woorden van de Joden, de Samaritanen, de farizeeën en de sadduceeën in 14:1 tot 7 in de opmaak, en verder de zin waartegen het boek waarschuwt — `Er is geen opstanding van de doden` — in 14:17, 14:24, 15:1, 15:11, 16:3 en 18:5, met als spreker `wie zo spreekt`. In 12:1 tot 3 en in 12:6 spreekt God in de eerste persoon; die verzen staan op naam van God, en de formule `zegt God, de Heilige van Israël` blijft binnen dat citaat, zoals overal in deze uitgave.

De aanspreekvorm volgt de verhouding tussen de sprekers. De profeet spreekt Meqabis aan met u, zoals een profeet een koning aanspreekt; God spreekt hem aan met je. Koning Tsirutsaydan beveelt de zonen van Meqabis in 6:10 met jullie, maar wanneer zij hem 's nachts verschijnen noemt hij hen in 6:15 `mijne heren` en spreekt hij hen aan met u; die omkering staat in de bron zelf.

### A13 — Opmaakresten in de bron van de Ethiopische boeken

In de Ethiopische boeken zijn bij het inlezen verwijzingen naar voetnoten in de tekst blijven staan: als `[^1]` in Henoch, Jubileeën en 1 en 2 Meqabyan, en in 2 Meqabyan daarnaast vijftien keer als `<sup>1</sup>`. De parafrase neemt die verwijzingen niet over. Voor de bronfrase is dat wel een probleem, want die moet letterlijk in de bron voorkomen en mag geen opmaak bevatten. Waar de regel opmaak bevat, wijst het anker daarom naar het langste aaneengesloten stuk van diezelfde regel dat geen opmaak heeft. Het anker blijft zo controleerbaar, en de resten in de bron blijven staan waar ze staan: het opruimen ervan hoort bij de brontekst en niet bij deze uitgave.

### A14 — 1 Meqabyan: het verhaal, de aanspraak en het woord van God

1 Meqabyan begint met het verhaal van koning Tsiruts'aidan en de zonen van Meqabyos, en van hoofdstuk 5 af wordt het één lange aanspraak tot koningen en vorsten. Het verhaal krijgt gewone opmaak: de bevelen van de koning en het weigeren van de broers in 2:3 tot 5 en in 3:5 tot 33, hun gebed in 2:17 tot 26, de stem uit de hemel in 3:1, en het nachtelijk gesprek na hun dood in 4:2 tot 27.

In de aanspraak daarna geldt de regel van de lerende stem: het betoog zelf krijgt geen opmaak, wat het aanhaalt wel. Dat zijn het woord van Mozes in 7:7, 7:26, 11:6 tot 8 en 14:7 tot 9 en 14:18, van David in 6:14, 8:20, 19:9 en 19:13, van Asaf in 24:8 tot 22, en van het boek van de geslachten in 13:25. Grote stukken van het boek zijn woord van God in de eerste persoon, en die staan op naam van God: 12:14 tot 44, 13:1 en 2 en 8 en 9, 22:10 en 11, 24:2 tot 5, 25:1 tot 7, 29:6 tot 13, 29:17 tot 30:16, 31, 32, 33, 34:4 tot 6 en 34:10 tot 13, 35:3 en 4, en 36:6 tot 12 en 36:14 en 36:22. De formule `zegt God die over alles heerst` blijft binnen dat citaat, zoals overal in deze uitgave.

De aanspreekvorm volgt weer de verhouding tussen de sprekers. Het boek spreekt de koning aan met u, zoals een profeet een koning aanspreekt, en dat blijft zo van hoofdstuk 5 tot en met 24. God spreekt koningen en volk aan met je en jullie. De morgenster in 13:12 tot 17 en de dochter van Jeruzalem in hoofdstuk 11 en 12 worden met jij aangesproken, omdat zij tegenover God staan en niet boven de spreker.

In 7:10 slaat de bron binnen één zin om van de derde naar de eerste persoon: `als u Mijn woord niet bewaard hebt`, terwijl de rest van het vers over God in de derde persoon spreekt. De parafrase leest hier Zijn woord, zodat de zin één spreker houdt. De bronfrase bewaart de regel zoals hij er staat. In 13:12 breekt de bron af in `gelijk gezegd is: Waarom?`; dat blijft staan zoals het er staat, zonder aanvulling en zonder opmaak.

### A15 — Henoch: een ik-verslag van begin tot eind

Henoch vertelt zijn visioenen zelf, in de ik-vorm, en zulke vertelling krijgt geen citaatopmaak, net als in Ezra 8 en 9, in Nehemia 2 en in de eerste hoofdstukken van Tobit. Dat geldt ook waar hij zich rechtstreeks tot zijn lezers of tot zijn zoon richt: de oproep aan de wachters in 14:4 tot 7, het begin van de gelijkenissen in 37:2, de slotwoorden van het sterrenboek in 79:1 en 82:1, en de inleiding van de dromen in 83:1 en 91:1. Waar de bron er wél een verteller omheen zet — `En Henoch ging heen en zei tot Azazel` in 13:1, `En hij sprak tot al zijn kinderen` in 91:3, `En Henoch zei` in 93:1 en 93:3 — staat zijn rede wel in de opmaak, want dan spreekt het boek over hem in de derde persoon.

Wat anderen zeggen, staat overal in de opmaak: de engelen op de Hermon in 6:2 tot 4, de aanklacht van de vier aartsengelen in 9:2 tot 11, de opdrachten van God aan Arsjelaljur, Rafaël, Gabriël en Michaël in 10:2 tot 11:2, het woord van God aan Henoch in 14:24 en 15:1 tot 16:4, de uitleg van Uriël, Rafaël, Raguël en Michaël bij elk visioen, de gesprekken rond de geboorte van Noach in 106, en de laatste uitleg van de engel in 108:6 tot 15. In 108:11 en 12 spreekt God binnen die uitleg in de eerste persoon; die twee verzen staan daarom als citaat binnen het citaat.

De aanspreekvorm volgt weer de verhouding. Engelen en God spreken Henoch aan met je, zoals God in deze uitgave altijd tegen mensen spreekt; Henoch spreekt engelen aan met u. Noach spreekt zijn overgrootvader Henoch aan met u, en Henoch spreekt hem aan met je; zo ook Lamech tegenover Metuselach en Metuselach tegenover Henoch in hoofdstuk 106.

Twee plaatsen slaan in de bron binnen één zin om van persoon. In 56:7 staat `de stad van Mijn rechtvaardigen` midden in wat de engel zegt, en in 108:10 staat `zegenden zij Mij toch` midden in wat de engel over God vertelt. De parafrase leest op beide plaatsen Zijn en Hem, zodat de zin één spreker houdt; de bronfrase bewaart de regel zoals hij er staat.

### A16 — Jubileeën: wat de engel die voor God staat aan Mozes vertelt

Jubileeën is wat de engel die voor God staat op de berg Sinaï aan Mozes vertelt en voor hem opschrijft. Na het eerste hoofdstuk, waarin een verteller Mozes de berg op laat gaan, spreekt het boek in de wij-vorm van de engelen. Die vertelling krijgt geen citaatopmaak, net als het ik-verslag van Henoch (A15). Dat geldt ook waar de engel zich rechtstreeks tot Mozes richt, zoals met `En u, gebied de kinderen van Israël` in 2:26, 6:13, 6:20 en 6:32 en met de opdracht in 6:38. Waar de bron er wél een verteller omheen zet, zoals in 2:1 (`En de engel van het aangezicht sprak tot Mozes naar het woord van God, zeggende`), staan de woorden van de engel in de opmaak.

Wat anderen zeggen, staat overal in de opmaak: God tegen Mozes en tegen de engel in hoofdstuk 1, tegen de engelen in 2:19 en 20, 3:4 en 10:22, tegen Noach in 6:5 tot 9 en over Mastema in 10:9; het gebed van Mozes in 1:19 tot 21; de vrouw en de slang in 3:18 en 19; Lamech bij de geboorte van Noach in 4:28; Noach bij zijn vloek en zegen in 7:10 tot 12, in zijn afscheidswoorden vanaf 7:26 en in zijn gebed in 10:3 tot 6; Mastema in 10:8; Peleg in 10:18; de bouwers van de toren in 10:19; en Cham met Cusch en Mitsraim tegen Kanaän in 10:30 tot 32. Het woord van God dat de vrouw in 3:18 aanhaalt, staat als citaat binnen het citaat. Geschreven woorden tellen als spraak (A3): waar de bron letterlijk aanhaalt wat op de platen in de hemel staat, in 4:5, 4:32 en 5:17, staat dat op naam van de platen in de hemel, en het `Zo zij het` van de getuigen in 4:5 staat daarbinnen als citaat binnen het citaat. In 3:24 en 6:5 begint het woord van God zonder aankondiging; die verzen staan toch op naam van God, omdat de inhoud geen andere spreker toelaat.

De aanspreekvorm volgt de verhouding (A14, A15). God en de engel spreken mensen aan met je en jullie, zoals overal in deze uitgave; Mozes en Noach spreken God aan met U. Noach spreekt zijn zonen aan met jullie, en Cham en zijn zonen spreken Kanaän aan met je.

De engel van het aangezicht heet in de parafrase de engel die voor God staat, zoals Openbaring 8:2 spreekt van de engelen die voor God staan; de engelen van de heiliging heten de engelen die aan God gewijd zijn. De stenen tafelen heten stenen platen, zoals in Exodus 24 en 31, en de tafelen van de hemel daarom de platen in de hemel. Een week van jaren heet een jaarweek: zeven jaar, zoals Leviticus 25:8 perioden van zeven jaar telt. De nieuwe maan als datum wordt de eerste dag van de maand, zoals in Genesis 8:5 en 8:13; als feest in 1:14 blijft het de nieuwe maan. De hemelse wezens die de bron in 4:22, 7:21, 8:3 en 10:5 wachters noemt, heten zo ook in de parafrase.

Waar Genesis dezelfde personen noemt, volgen de namen Genesis (A1): Mahalal-el, Jered, Methusalach, Jafeth, Arfachsad, Selah, Heber, Rehu, Cusch, Mitsraim en Thiras, en Kaïnan zoals in Lukas 3:36. Namen die alleen Jubileeën kent, houden de spelling van de Open Vertaling, zoals Mêlka, Mû'ak en Lômna. Waar de bron één naam op twee manieren spelt, houdt de parafrase één vorm aan: Neëlatamaük in 7:14 en 7:17, en Mastema, dat alleen in 10:8 als Mastêma geschreven staat.

De Open Vertaling van Jubileeën is op veel plaatsen korter dan de volledige Ethiopische tekst, en de parafrase vult niets aan (A2, A11). In 3:17 ontbreekt de vraag van de slang, zodat vers 18 met het antwoord van de vrouw begint; `tot hem` is daar op de slang gezet, omdat zij in vers 19 antwoordt. In 3:25 breekt het woord aan Adam af na de reden; de parafrase maakt er een volzin van zonder de vloek aan te vullen. 4:16 noemt de geboorte van Henoch niet, terwijl 4:17 met `Hij` over hem begint; de parafrase noemt hem daar bij naam. 6:23 noemt drie van de vier dagen van de herinnering; de zevende maand, die 6:26 wel noemt, is in vers 23 niet aangevuld. In 8:8 ontbreekt het huwelijk van Heber, zodat de parafrase alleen zegt dat Peleg geboren werd. In hoofdstuk 9 ontbreekt het deel van Magog: Madai krijgt een deel zonder rangnummer en Javan het vierde. Twee verwijzingen zijn verduidelijkt: in 5:10 zijn `hun vaderen` de engelen uit vers 6, en in 7:38 heet Henoch, `de vader van uw vader`, de voorvader van de zonen van Noach. De bronfrase bewaart telkens de regel zoals hij er staat.

Vanaf hoofdstuk 11 volgt het boek Abraham, Izak en Jakob, en daar wordt veel meer gesproken. De lange redes van Abraham tot zijn nakomelingen in 20:4 tot 10, tot Izak in 21:1 tot 25 en tot Jakob in 22:10 tot 30, de zegen van Rebekka in 25:12 tot 23 en de vloek van Izak over de Filistijnen in 24:28 tot 32 staan op naam van de spreker, ook waar een vers geen eigen aankondiging heeft. Wat de engel die het boek vertelt zelf tegen Abraham roept, in 18:10 en 11, staat op zijn naam, zoals de woorden die Ezra binnen zijn eigen verslag uitspreekt (A3). Waar een spreker de woorden van een ander aanhaalt, zoals Abraham de koning van Sodom in 13:29 en Jakob zijn broer Ezau in 25:8, staat dat als citaat binnen het citaat. Wat mensen plegen te zeggen, zoals `God heeft gezien` in 18:13 en de uitspraken over het korte leven in 23:12 en 15, staat op naam van de mensen (A8).

De aanspreekvorm volgt ook hier de verhouding. Abraham, Terah en Izak spreken hun kinderen aan met je, en de kinderen hun vader of moeder met u. De koning van Sodom en de Hethieten spreken Abraham aan met u, en Abraham de koning met je, zoals in Genesis 14:23.

Waar de bron JAHWEH schrijft, in 17:14, 18:15 en 19:29, staat in de parafrase de HEERE, zoals overal in het Oude Testament van deze uitgave. El Elyon is de allerhoogste God, zoals in Genesis 14, en El Shaddai in 15:3 God, de Almachtige, zoals in Genesis 17:1. Plaatsen waarvan de bron de naam vertaalt, krijgen de naam uit Genesis: de Bron van de Eed is Berseba, de Bron van het Gezicht de put Lachai-Roï, de dubbele grot de grot van Machpela, en Tanais is Zoan, zoals in Numeri 13:22. Waar het verhaal op de betekenis van een naam draait, zoals bij Benauwdheid en Ruimte in 24:20, blijft de vertaalde naam staan. De koningen in 13:22 heten zoals in Genesis 14: Kedor-laomer, Arioch van Ellasar en Tideal, waar de bron Sellasar en Tergal heeft. Belial staat zoals in 2 Korinthiërs 6:15, ook in 1:20, waar de bron Beliar schrijft; en de zoon van Kesed heet in 11:3 net als in 11:1 Ur, waar de bron Ud schrijft.

Ook in deze hoofdstukken is de Open Vertaling op veel plaatsen korter dan de volledige Ethiopische tekst. Vier verzen zijn alleen een tijdsaanduiding zonder hoofdzin: 11:14, 12:12, 12:22 en 13:19. De parafrase maakt er een korte volzin van, zoals `Toen kwam het eerste jaar van de tweede jaarweek van dit negenendertigste jubeljaar`, zonder het ontbrekende aan te vullen. In 11:8, 11:15 en 14:24 ontbreken het huwelijk of de naam die bij een geboorte horen; de parafrase zegt dan alleen dat er een zoon geboren werd. Tussen 12:22 en 12:23 ontbreekt de roeping van Abram, zodat het woord van God in 12:23 zonder aankondiging begint; hetzelfde geldt voor 13:20, en tussen 18:6 en 18:7 ontbreekt de vraag van Izak naar het lam. In 15:27 staat alleen `Want zij zijn allen engelen van het aangezicht`, in 16:24 noemt de bron zes geurstoffen en zegt `deze zeven`, en in 22:17 ontbreekt wie `zij` zijn; de parafrase geeft die zinnen zoals ze er staan. In 16:16 is `hem` op Abraham gezet, omdat de zes zonen die volgen de zonen van Ketura zijn (19:12), en in 19:17 is `haar` op Rebekka gezet. In 25:4 zijn `negen weken van jaren` omgerekend tot 63 jaar. Ook hier bewaart de bronfrase de regel zoals hij er staat.

In de hoofdstukken 26 tot en met 40 gaat het verhaal over Jakob en zijn zonen. Hoofdstuk 26 heeft geen vers 33: de bron slaat dat nummer over en de parafrase volgt die nummering, zodat de zegen voor Ezau in 26:34 zonder aankondiging begint. Waar de bron een wet letterlijk aanhaalt, geldt dezelfde regel als eerder: in 30:9 staat die op naam van de platen in de hemel en in 33:12 op naam van de wet, met het `Het zij zo, het zij zo` van de heiligen van God als eigen citaat. In 33:15 staat de zin waartegen de engel waarschuwt op naam van wie zo spreekt (A8). In 31:10 staat `Werkelijk hebt u gezien dat het werkelijk mijn zonen zijn` op naam van Jakob, omdat hij zijn vader met u aanspreekt, en in 40:4 begint de raad van Jozef aan Farao zonder aankondiging.

Izak noemt Rebekka in 27:14 en 17 `mijn zuster`; de parafrase maakt daar `mijn lieve vrouw` van, omdat een zus in het Nederlands van nu alleen een bloedverwant is. Izak en Rebekka spreken elkaar aan met je, de zonen van Ezau hun vader met u, en Ezau zijn broer Jakob met je.

De namen volgen ook hier Genesis: Migdal-Eder voor Magdaladraëf in 33:1, Hanoch, de zoon van Ruben, in 38:8, Nafthali in 38:5, en Zafnath Paäneah voor Sefantifans in 40:10. De koningen van Edom in 38:16 tot 23 heten zoals in Genesis 36, zodat Balak, de zoon van Beor, daar Bela is. Waar de bron een naam vertaalt en de naam uit Genesis er zelf bij hoort, staan ze allebei: Ben-oni, zoon van mijn pijn, in 32:33, en Allon-Bachuth, de eik van de rouw om Debora, in 32:30. Waar de bron JAHWEH schrijft, in 31:16, staat de HEERE.

Verwijzingen die in de bron niet te volgen zijn, staan met naam: Ezau in 26:26, Bilha in 28:18 (zoals vers 19 haar noemt), Jakob in 29:13, de engel in 32:26, de zonen van Jakob in 34:2, zijn Egyptische heer in 39:3 en Jozef in 39:12; in 36:21 is Rebekka de moeder van Jakob, waar de bron `haar moeder` schrijft. Wat in de Open Vertaling ontbreekt, is ook hier niet aangevuld: hoe Jakob zijn zonen telde zodat Levi het tiende deel werd (32:3), het antwoord op de vraag van Jakob (32:25), de namen na Ruben (33:22), de verkoop van Jozef (34:11), de vrouwen van de zonen van Jakob (34:21), de toenadering van de vrouw van de Egyptenaar (39:6) en de uitleg van de dromen van Farao (40:3). 34:1 is weer een tijdsaanduiding zonder hoofdzin, 28:7 een losse opdracht aan Mozes, en in 37:23 blijft de witte raza staan zoals de bron hem noemt. De bronfrase bewaart de regel zoals hij er staat.

In de hoofdstukken 41 tot en met 50 loopt het boek van Juda en Tamar tot na de uittocht uit Egypte, en vanaf hoofdstuk 46 spreekt de engel Mozes weer rechtstreeks aan: `jouw vader Amram`, `jij werd geboren`. Die aanspraak krijgt geen opmaak, net als in 2:26 en 6:13. Waar de engel in 48:4, 48:13 en 50:1 tot 6 over zichzelf spreekt, schrijft de bron Ik met een hoofdletter, alsof God aan het woord is; de parafrase schrijft ik, omdat de engel vertelt. Waar een spreker aanhaalt wat een ander moet zeggen, zoals Jozef de woorden voor zijn beheerder in 43:2, staat dat als citaat binnen het citaat. In 43:12 blijft staan dat de jongen zal sterven, zoals de bron het zegt.

De lijst van de nakomelingen van Jakob in 44:11 tot 34 volgt de namen van Genesis 46 waar het om dezelfde personen gaat: Hanoch, Schuni, Eri voor Edis, Jahleel, Chusim en Sillem, en de tien zonen van Benjamin, die de bron in verbasterde vorm geeft. Asnath is de dochter van Potifera, de priester van On, waar de bron Potifar en Heliopolis noemt. Namen die alleen Jubileeën kent, zoals Samon, Asudi, Ijaka, Salomon en Iv, blijven staan, en ook de Fenicische vrouw van Simeon en de naam Jasub, die uit Numeri 26 bekend is. De dochter van Farao heet in 47:5 Tharmut en de vrouw van Juda in 41:7 Bedsuël, zoals in de bron.

Twee plaatsen zijn in de bron zelf verschreven. In 44:1 vertrekt Israël uit Haran, terwijl hij sinds 36:20 in Hebron woont, en in 50:1 ligt de woestijn van Sinai tussen Elim en Sinai, waar Exodus 16:1 de woestijn Sin noemt. De parafrase leest op die plaatsen Hebron en Sin. Verwijzingen staan weer met naam waar de bron niet te volgen is: Er in 41:2, Onan als de broer van Er in 41:4, Juda in 41:27, de beheerder in 43:1, de koning van Kanaän in 46:7, de koning van Egypte in 46:12, de moeder van Mozes in 47:4 en de machten van God in 49:3. 45:10 is een losse tijdsaanduiding, die de parafrase weergeeft als `Zo ging het in de zeven jaren van hongersnood`. Wat ontbreekt, is ook hier niet aangevuld: de dood van Onan (41:5), de beschuldiging van Jozef tegen zijn broers (42:5), de opdracht aan de beheerder (42:25), de doodslag op de Egyptenaar (47:10) en het land Midian (48:1). De bronfrase bewaart de regel zoals hij er staat.
